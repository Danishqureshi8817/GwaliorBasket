  ...
  return (
    <>
            ...
            <Grid item xs={11.6} p={2} py={4} mx="auto" bgcolor="white" mt={3} container  gap={3}>
              ...
              <div style={{ display: "flex",alignItems:'center',justifyContent:'center',width:400}}>
               ...
               <div>{userdata[0]?.fullname}</div>
                <div>{userdata[0]?.city} {userdata?.state}</div>
      ...
      {   keys.length==0 ? <Button disabled={true} onClick={handleClick} fullWidth size="large" variant="contained">
                {btnMsg}
              </Button>: <Button disabled={false} onClick={handleClick} fullWidth size="large" variant="contained">
                {btnMsg}
              </Button>}
            </Grid>
          </Grid>
      ...
      <LoginDialog setBtnMsg={setBtnMsg} userData={userData} setUserData={setUserData} setDialogState={setDialogState}  state={dialogState} setAddressState={setAddressState} pageRefresh={pageRefresh} />
